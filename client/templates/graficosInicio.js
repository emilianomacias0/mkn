...
Template.home.onRendered(function() {
    ...
    var ctx2 = document.getElementById("mensual4").getContext("2d");
    var ctx3 = document.getElementById("mensual1").getContext("2d");
    var ctx4 = document.getElementById("mensual2").getContext("2d");
    var ctx5 = document.getElementById("mensual3").getContext("2d");
